...
Download the TSANet Postman collection from the [Postman Collection](file:///4796169/api-reference/postman-collection.md) page. Use it to test all API calls manually before wiring them into the integration.
